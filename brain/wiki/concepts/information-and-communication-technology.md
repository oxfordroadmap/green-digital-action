...
- [[concepts/e-adaptation|e-Adaptation]]
- [[concepts/greening-by-digital|Greening by Digital]]
- [[concepts/green-digital-action|Green Digital Action]]

## Related Entities
- [[entities/centre-for-development-informatics|Centre for Development Informatics]]

## Mentions in Source
- "Information and communication technologies (ICTs) deliver innovative products and services which are transforming the way human societies live." — [[sources/itu-t-l-1500-adaptation-framework|ITU-T L.1500 (Adaptation Framework)]]
- "ICT is a prerequisite for successful adaptation to climate change." — [[sources/itu-t-l-1500-adaptation-framework|ITU-T L.1500 (Adaptation Framework)]]
- "In order to incorporate ICT into climate change adaptation responses and monitoring, (within specific development contexts) policies referred to as ICTs, Climate Change and Development Policies (ICCD) can be developed." — [[sources/itu-t-l-1501-adaptation-best-practices|ITU-T L.1501 (Adaptation Best Practices)]]