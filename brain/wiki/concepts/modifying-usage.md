...
## Key Characteristics
- Directly alters an existing activity in the [[concepts/reference-scenario|Reference scenario]].
...
## Mentions in Source
- "Modifying usage: A usage of an ICT solution that modifies an activity in the reference scenario." — [[sources/itu-t-l-1480-greening-by-digital|ITU-T L.1480 (Greening by Digital)]]